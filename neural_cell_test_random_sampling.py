...
all_H37Rv_non_TF_genes = ['Rv1979c','Rv1980c','Rv1981c','Rv1982c','Rv1983','Rv1984c','Rv1995','Rv1996','Rv1997','Rv1998c','Rv1999c','Rv2000','Rv2001','Rv2002','Rv2003c','Rv2004c','Rv2005c','Rv2006','Rv2007c','Rv2008c','Rv2009','Rv2010','Rv2011c','Rv2012','Rv2013','Rv2014','Rv2015c','Rv2016','Rv2017','Rv2018','Rv2019','Rv2020c','Rv2021c','Rv2022c','Rv2023A','Rv2023c']
...
def get_sub_list_from_network(origional_network, a_gene, a_label, edge_threshold, *extra_gene_list):
	...
	if len(extra_gene_list) > 0:
		needed_input_nodes = len(all_nodes_list)
		random_list = []
		random_list.append(a_gene)

		gene_count = 0

		while gene_count < needed_input_nodes:
			print random.choice(all_H37Rv_non_TF_genes)
			random_list.append(random.choice(all_H37Rv_non_TF_genes))

			gene_count += 1

		all_nodes_list = random_list
...
def ANN_blind_analysis_multi_hidden(a_network, a_gene, a_dataset, boot_val, train_for):
	...
	upper_case_data_node_list = get_sub_list_from_network(a_network, a_gene, "TF", 1, all_H37Rv_non_TF_genes)
	print upper_case_data_node_list
