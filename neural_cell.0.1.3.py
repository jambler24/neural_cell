...
def ANN_blind_analysis_multi_hidden(a_network, a_gene, a_dataset, boot_val, train_for, filter_threshold):
	...
	a_filtered_dataset = filter_expression_dataset(data_node_list, a_filtered_dataset, filter_threshold)
	...
	result_list.append(len(a_filtered_dataset))

	return result_list

def ANN_blind_analysis_single_hidden(a_network, a_gene, a_dataset, boot_val, train_for, filter_threshold):
...
def ANN_blind_analysis_no_hidden(a_network, a_gene, a_dataset, boot_val, train_for, filter_threshold):
...
def ANN_blind_analysis_old(a_network, a_gene, a_dataset, boot_val):
...
def create_optimized_network(organism_network, shared_dataset, bootstrap_value, train_for, result_file, filter_threshold_val, *gene_list_path):
	...
	for target_gene_node in list_of_nodes_for_analysis:
		...
		analysis_output = ANN_blind_analysis_multi_hidden(organism_network, target_gene_node, instance_dataset, bootstrap_value, train_for, filter_threshold_val)
		#analysis_output = ANN_blind_analysis_single_hidden(organism_network, target_gene_node, instance_dataset, bootstrap_value, train_for, filter_threshold_val)
		#analysis_output = ANN_blind_analysis_no_hidden(organism_network, target_gene_node, instance_dataset, bootstrap_value, train_for, filter_threshold_val)
		


		print analysis_output
		writen_line = target_gene_node + ';' + str(analysis_output[1]) + ';' + str(analysis_output[2]) + ';' + str(analysis_output[3]) + '\n'
		print writen_line
